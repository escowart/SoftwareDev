...
class TestConvertSituation(unittest.TestCase):
    ...
    def test_pj_species(self):
        ...
        self.assertRaises(ValueError,
                                convert_from_pj_species, self.ex_pj_species.spe_max_f1)

        self.assertRaises(ValueError,
                                convert_from_pj_species, self.ex_pj_species.spe_max_b1)

        self.assertRaises(ValueError,
                                convert_from_pj_species, self.ex_pj_species.spe_max_p1)

        self.assertRaises(ValueError,
                                convert_from_pj_species, self.ex_pj_species.spe_dup)
